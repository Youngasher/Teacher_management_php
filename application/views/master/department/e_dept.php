        ...
        <div class="container-fluid">
          ...
          <form action="" method="POST" class="col-lg-5  p-0">
            <div class="card">
              <h5 class="card-header">Class Master Data</h5>
              <div class="card-body">
                <h5 class="card-title">Edit Class</h5>
                <p class="card-text">Form to edit class in system</p>
                <div class="form-group">
                  <label for="department_id" class="col-form-label-lg">Class ID</label>
                  <input type="text" readonly class="form-control-plaintext form-control-lg" name="d_id" value="<?= $d_old['id']; ?>">
                </div>
                <div class="form-group">
                  <label for="d_name" class="col-form-label-lg">Class Name</label>
