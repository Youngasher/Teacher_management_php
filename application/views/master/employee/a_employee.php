          ...
          <div class="col-lg-10 p-0">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Form to add new teacher to system</p>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group row">
                      <label for="e_name" class="col-form-label col-lg-4">Teacher Name</label>
                      <div class="col p-0">
                    ...
                    <div class="form-group row">
                      <label for="d_id" class="col-form-label col-lg-4">Class Name</label>
                      <div class="col p-0">
                  ...
                  <div class="col-lg-6">
                    <!--
                    <div class="form-group row">
                      <label for="image" class="col-form-label col-lg-4">Teacher Image</label>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col p-0">
                        <select class="form-control" name="s_id" id="s_id">
                          ...
                          -->
                    <div class="form-group row">
                      <label for="e_birth_date" class="col-form-label col-lg-4">Teacher D.O.B</label>
