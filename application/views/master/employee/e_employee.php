        ...
        <div class="container-fluid">
          ...
          <div class="col-lg p-0">
            <div class="row">
              ...
              <div class="col-lg-3">
                <div class="card" style="width: 100%; height: 100%">
                  ...
                  <div class="card-body mt-3">
                    <label for="image">Change Teacher Image</label>
              ...
              <div class="col-lg-6">
                <div class="card">
                  <h5 class="card-header">Teacher Master Data</h5>
                  <div class="card-body">
                    <h5 class="card-title">Edit Teacher</h5>
                    <p class="card-text">Form to edit teacher in system</p>
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="employee_id" class="col-form-label">Teacher ID</label>
                          <input type="text" readonly class="form-control-plaintext" name="e_id" value="<?= $employee['id']; ?>">
                        </div>
                      </div>
                      <div class="col-lg-8">
                        <div class="form-group">
                          <label for="e_name" class="col-form-label">Teacher Name</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="e_birth_date" class="col-form-label">Teacher D.O.B</label>
                          <div class="col-lg p-0">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label for="d_id" class="col-form-label">Class</label>
                    ...
                    <div class="text-center"> <!-- Center the button within a container -->
  <button type="submit" class="btn btn-success btn-icon-split mt-4 btn-sm"> <!-- Add btn-sm class for small size -->
    <span class="icon text-white">
