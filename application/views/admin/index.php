               ...
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     ...
                     <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $display['c_department']; ?> Classes</div>
                   </div>
                   <div class="col-auto">
               ...
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     ...
                     <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $display['c_employee']; ?> Teachers</div>
                   </div>
                   <div class="col-auto">
             ...
             <div class="col p-0">
               <div class="card shadow mb-4">
                 ...
                 <div class="card-header py-3 d-flex flex-rowz align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-primary">Classes' Teachers</h6>
                   <div class="dropdown no-arrow">
                     ...
                     <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                       ...
                       <a class="dropdown-item" href="<?= base_url('admin') ?>">Class List</a>
                     </div>
                   </div>
                 </div>
                 <!-- Card Body -->
